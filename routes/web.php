...
Route::middleware('auth')->group(function () {
    ...
    Route::get('vehicles/{id}/edit', [VehicleController::class,'edit'])->name('settings.vehicles.edit')->middleware('role:director');
    ...
    Route::get('owners/{id}/edit', [OwnerController::class,'edit'])->name('settings.owners.edit')->middleware('role:director');
    ...
    Route::get('drivers/{id}/edit', [DriverController::class,'edit'])->name('settings.drivers.edit')->middleware('role:director');
    ...
    Route::get('departures/edit/{id}',[DepartureController::class,'edit'])->name('departures.edit')->middleware('role:director');
    ...
    Route::get('payments/edit/{id}',[PaymentController::class,'edit'])->name('payments.edit')->middleware('role:director');
    ...
    Route::get('cash/incomes/{id}/edit',[CashController::class,'editIncome'])->name('cash.incomes.edit')->middleware('role:director');
    ...
    Route::get('cash/expenses/{id}/edit',[CashController::class,'editExpense'])->name('cash.expenses.edit')->middleware('role:director');
