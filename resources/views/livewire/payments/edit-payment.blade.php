            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="edit-payment-form" class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input id="pay_plate_edit" type="text" class="form-control" placeholder="ABC-123"
                        ...
                        <div class="col-md-6" style="position:absolute; left:-9999px;">
                            <div class="mb-3">
                                ...
                                <input id="pay_lat_edit" type="text" class="form-control" wire:model.defer="latitude" readonly>
                            </div>
                        </div>
                        <div class="col-md-6" style="position:absolute; left:-9999px;">
                            <div class="mb-3">
                                <label class="form-label visually-hidden">Longitud</label>
                                <input id="pay_lng_edit" type="text" class="form-control" wire:model.defer="longitude" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('payments.index') }}" class="btn btn-primary">Volver</a>
                    </div>
                </div>
            </div>
        </div>
