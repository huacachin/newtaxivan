...
<div class="row g-3">
    ...
    <div class="col-12 col-md-6">
        ...
        <textarea id="detail" rows="3" class="form-control form-control-sm" placeholder="Observaciones..." wire:model="detail"></textarea>
        @error('detail') <span class="title-modules">{{ $message }}</span> @enderror
    </div>

    <div class="col-12 col-md-6 d-md-flex flex-md-column justify-content-md-center align-items-md-start">
        ...
        @elseif(isset($existing_image) && $existing_image)
            <div class="position-relative d-inline-block mt-2" style="max-height:80px">
                <img src="{{ asset('storage/' . $existing_image) }}" alt="Foto vehículo" class="rounded"
                     style="max-height:80px; cursor:pointer"
                     onclick="openImagePreview(this.src)"
                     title="Click para ampliar">
                <button type="button"
