...
<div class="row g-3">
    ...
    <div class="col-6 col-md-4">
        ...
        <select id="type" class="form-control form-control-sm" wire:model="type">
            <option value="">Seleccionar</option>
    ...
    <div class="col-6 col-md-4">
        ...
        <select id="owner_id" class="form-control form-control-sm" wire:model="owner_id">
            <option value="">Seleccionar</option>
    ...
    <div class="col-6 col-md-4">
        ...
        <select id="driver_id" class="form-control form-control-sm" wire:model="driver_id">
            <option value="">Seleccionar</option>
