        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-6 col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" value="{{ $vehicle->plate }}" readonly>
                </div>

                {{-- Documento --}}
                <div class="col-6 col-md-3">
                    <label class="form-label">Documento</label>
                    <input type="text" class="form-control form-control-sm" value="{{ $meta['label'] }}" readonly>
                </div>
                ...
                <div class="col-6 col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" value="{{ $meta['current'] ?? '—' }}" readonly>
                </div>
