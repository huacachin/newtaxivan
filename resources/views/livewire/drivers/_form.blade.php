...
<div class="row g-3">
    ...
    <div class="col-12"><div class="app-divider-v justify-content-center"><p>DETALLES Y FOTOS</p></div></div>

    <div class="col-12">
        <label class="form-label">Detalles</label>
        <textarea class="form-control form-control-sm" rows="2" placeholder="Detalles adicionales del conductor..." wire:model="details"></textarea>
