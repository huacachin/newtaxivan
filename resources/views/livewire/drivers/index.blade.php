                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                @hasanyrole('director')<th>Acción</th>@endhasanyrole
                                <th>Item</th>
                                <th>Cod</th>
                                <th>Placa</th>
                                <th>Nombre</th>
                            ...
                            @if($drivers->count() > 0)
                                ...
                                @endforeach
                            @else
                                <tr><td colspan="{{ auth()->user()->isDirector() ? 10 : 9 }}">No se encontrarón resultados</td></tr>
                            @endif
                            </tbody>
                            <tfoot class="bg-primary">
                            <tr>
                                <td colspan="{{ auth()->user()->isDirector() ? 10 : 9 }}" class="text-end f-w-600">TOTAL: {{ $drivers->count() }}</td>
                            </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                @empty
                                    <tr><td colspan="{{ auth()->user()->isDirector() ? 8 : 7 }}">No se encontrarón resultados</td></tr>
                                @endforelse
                                </tbody>
                                <tfoot class="bg-primary">
                                <tr>
                                    <td colspan="{{ auth()->user()->isDirector() ? 8 : 7 }}" class="text-end f-w-600">TOTAL: {{ $driversFree->count() }}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
