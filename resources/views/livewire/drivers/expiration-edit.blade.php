{{-- resources/views/livewire/drivers/expiration-edit.blade.php --}}
@push('datepicker_css')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="main-title title-modules">CONDUCTOR: ACTUALIZAR VENCIMIENTO</h4>
        </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-6 col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" value="{{ $driver->name }}" disabled>
                </div>
                ...
                @include('livewire.partials._multi-photos', ['entityLabel' => 'conductor'])
            ...
            <div class="mt-3 d-flex gap-2 justify-content-end">
                ...
                <a href="{{ route('settings.drivers.index') }}" class="btn btn-sm btn-secondary">
