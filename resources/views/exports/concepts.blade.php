...
<body>
<center><b style="color:red; font-size:11pt;">CONCEPTOS</b></center><br>
<table cellspacing="0" border="1" style="border-collapse:collapse;">
    <thead>
    <tr>
        <th bgcolor="#2874A6" align="center" style="color:white;"><b>Item</b></th>
        <th bgcolor="#2874A6" align="center" style="color:white;"><b>C&oacute;digo</b></th>
    ...
    @foreach($rows as $row)
        <tr>
            ...
            <td style="border-style:dotted solid dotted solid;text-align:center;vertical-align:middle;">{{ $row['code'] }}</td>
